 ...
 */
public class ImageAndroidView extends GenericDraweeView {
            ...
            mControllerListener = new BaseControllerListener<ImageInfo>() {
                ...
                public void onSubmit(String id, Object callerContext) {
                    mEventDispatcher.dispatchEvent(
                            new ImageAndroidLoadEvent(getId(), SystemClock.uptimeMillis(), ImageAndroidLoadEvent.ON_LOAD_START)
                    );
                }
                ...
                public void onFinalImageSet(
                    ...
                    if (imageInfo != null) {
                        mEventDispatcher.dispatchEvent(
                                new ImageAndroidLoadEvent(getId(), SystemClock.uptimeMillis(), ImageAndroidLoadEvent.ON_LOAD_END)
                        );
                        // 在图片加载完成时调用onInfo，输出宽高
                        mEventDispatcher.dispatchEvent(
                                new ImageAndroidLoadEvent(getId(), SystemClock.uptimeMillis(), ImageAndroidLoadEvent.ON_LOAD,
